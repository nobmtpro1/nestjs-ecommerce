...
export class Migration1699068610461 implements MigrationInterface {
    name = 'Migration1699068610461'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`product_variant\` (\`id\` varchar(36) NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`sku\` varchar(255) NULL, \`status\` int NOT NULL DEFAULT '1', \`downloadable\` tinyint NOT NULL DEFAULT 0, \`isVirtual\` tinyint NOT NULL DEFAULT 0, \`isManageStock\` tinyint NOT NULL DEFAULT 0, \`regularPrice\` bigint NOT NULL DEFAULT '0', \`salePrice\` bigint NOT NULL DEFAULT '0', \`salePriceFrom\` date NULL, \`salePriceTo\` date NULL, \`soldIndividually\` tinyint NOT NULL DEFAULT 0, \`stock\` int NULL, \`stockStatus\` int NOT NULL DEFAULT '1', \`weight\` float NULL, \`length\` float NULL, \`width\` float NULL, \`height\` float NULL, \`productId\` varchar(36) NULL, \`imageId\` varchar(36) NULL, \`productAttributeValue1Id\` varchar(36) NULL, \`productAttributeValue2Id\` varchar(36) NULL, \`productAttributeValue3Id\` varchar(36) NULL, UNIQUE INDEX \`REL_b83f23626741630a8629960715\` (\`imageId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`sku\` \`sku\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`salePriceFrom\` \`salePriceFrom\` date NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`salePriceTo\` \`salePriceTo\` date NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`stock\` \`stock\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`weight\` \`weight\` float NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`length\` \`length\` float NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`width\` \`width\` float NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`height\` \`height\` float NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`productId\` \`productId\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`imageId\` \`imageId\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`productAttributeValue1Id\` \`productAttributeValue1Id\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`productAttributeValue2Id\` \`productAttributeValue2Id\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`productAttributeValue3Id\` \`productAttributeValue3Id\` varchar(36) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`product_category\` DROP FOREIGN KEY \`FK_569b30aa4b0a1ad42bcd30916aa\``);
        await queryRunner.query(`ALTER TABLE \`product_category\` DROP FOREIGN KEY \`FK_f38e86bd280ff9c9c7d9cb78393\``);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`productAttributeValue3Id\` \`productAttributeValue3Id\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`productAttributeValue2Id\` \`productAttributeValue2Id\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`productAttributeValue1Id\` \`productAttributeValue1Id\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`imageId\` \`imageId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`productId\` \`productId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`height\` \`height\` float(12) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`width\` \`width\` float(12) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`length\` \`length\` float(12) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`weight\` \`weight\` float(12) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`stock\` \`stock\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`salePriceTo\` \`salePriceTo\` date NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`salePriceFrom\` \`salePriceFrom\` date NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` CHANGE \`sku\` \`sku\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` ADD CONSTRAINT \`FK_2bf3cfe8a26d6453ab9932ce0f7\` FOREIGN KEY (\`productAttributeValue3Id\`) REFERENCES \`product_attribute_value\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` ADD CONSTRAINT \`FK_b96615197baaa18bb5cf4d15b03\` FOREIGN KEY (\`productAttributeValue2Id\`) REFERENCES \`product_attribute_value\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` ADD CONSTRAINT \`FK_ca9621c237c371f80514bc2f77b\` FOREIGN KEY (\`productAttributeValue1Id\`) REFERENCES \`product_attribute_value\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`product_variation\` ADD CONSTRAINT \`FK_e406b1dcd62e293cf3113471642\` FOREIGN KEY (\`imageId\`) REFERENCES \`image\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`product_category\` ADD CONSTRAINT \`FK_569b30aa4b0a1ad42bcd30916aa\` FOREIGN KEY (\`parentId\`) REFERENCES \`product_category\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`product_category\` ADD CONSTRAINT \`FK_f38e86bd280ff9c9c7d9cb78393\` FOREIGN KEY (\`imageId\`) REFERENCES \`image\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`DROP INDEX \`REL_b83f23626741630a8629960715\` ON \`product_variant\``);
