...
export class UpdateUser1698722839821 implements MigrationInterface {
    name = 'UpdateUser1698722839821'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`roles\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`permissions\` text NULL`);
