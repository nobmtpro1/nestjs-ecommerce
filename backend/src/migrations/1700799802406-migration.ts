...
export class Migration1700799802406 implements MigrationInterface {
    name = 'Migration1700799802406'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user\` DROP FOREIGN KEY \`FK_14ecd7104647351e57a0c1d9786\``);
        await queryRunner.query(`DROP INDEX \`IDX_14ecd7104647351e57a0c1d978\` ON \`user\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_14ecd7104647351e57a0c1d978\` ON \`user\` (\`user_token_id\`)`);
