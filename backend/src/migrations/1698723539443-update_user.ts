...
export class UpdateUser1698723539443 implements MigrationInterface {
    name = 'UpdateUser1698723539443'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_569b30aa4b0a1ad42bcd30916aa\` ON \`product_category\``);
        await queryRunner.query(`DROP INDEX \`FK_c711bba5afd50a326a70865bfa3\` ON \`product_attribute_value\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`permissions\` \`permissions\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`roles\` \`roles\` text NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`CREATE INDEX \`FK_c711bba5afd50a326a70865bfa3\` ON \`product_attribute_value\` (\`productAttributeId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_569b30aa4b0a1ad42bcd30916aa\` ON \`product_category\` (\`parentId\`)`);
    }
